...
const EXPERIENCES: Experience[] = [
  {
    ...
    achievements: [
      "Built a computer vision–powered QA automation engine that replaced manual banner review with deterministic, pixel-level checks, cutting a multi-hour process down to seconds.",
      "Architected reusable validation pipelines spanning image processing, PDF parsing, and HTML analysis, turning one-off scripts into a reliable, extensible QA framework.",
      "Shipped production-grade tooling trusted to catch what the human eye misses, at enterprise scale.",
    ],
    current: true,
  },
  {

...
DB_PATH = str(Path(__file__).resolve().parent.parent / "resumeiq.db")
...
# ---------------------------------------------------------------------------
# Sessions (lightweight bearer tokens for the API — not JWT, good enough for
# a personal-project auth system, matching auth.py's stated scope)
# ---------------------------------------------------------------------------
